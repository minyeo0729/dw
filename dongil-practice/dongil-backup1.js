...
//oceanhills_slide_mobile(); // 오션힐즈 슬라이드 모바일
...
function oceanhills_hover_motion() {
  ...
  if( $('html').hasClass('desktop') ) {
    $item.on("mouseenter", function () {
        ...
        $(this).addClass("now-di--oceanhills-hover--active");
    
        if ($item.hasClass("now-di--oceanhills-hover--active")) {
          $(this).siblings().removeClass("now-di--oceanhills-hover--active");
        }
...
function oceanhills_scroll_motion_arc(){
    ...
    let tl = gsap.timeline({
        ...
        scrollTrigger: {
            ...
            pin: true,  
            start: "top top", 
            end: "max", //최댓값 지정하여 스크롤 스피드 조절
            //end: () => "+=" + $row_item.innerHeight() * 7, //height 592px짜리 총 7개 스크롤링 할 만큼의 스피드
            scrub: 1.2,
            pinSpacing: "margin", //pin-spacer로 인한 하단 여백 조절
        }
    });

    var $arc_geo = $('.now-di--oceanhills-arc-geo-obj');
    var $arc_river = $('.now-di--oceanhills-arc-river-bg');
    var $arc_arrows = $('.now-di--oceanhills-arc-river-arrows');
    var $arc_svg = $('.now-di--oceanhills-arc-river-arrows svg');
    ...
    tl.addLabel("sunpath")
        ...
        .set($arc_geo.find('figure:nth-child(5)'),{transformOrigin: "0% 0%"}, "forestplate")
        .fromTo($arc_geo.find('figure:nth-child(5)'),
        {scaleY: 0}, {opacity:1, scaleY: 1}, "forestplate") 

        .addLabel("oceanplate")
        .to($arc_geo.find('figure:nth-child(5)'), {opacity:0}, "oceanplate") 
        .set($arc_geo.find('figure:nth-child(6)'),{transformOrigin: "100% 0%"}, "oceanplate")
        .fromTo($arc_geo.find('figure:nth-child(6)'),
        {scaleX: 0}, {opacity:1, scaleX: 1}, "oceanplate") 
        ...
        .fromTo($arc_arrows.find('figure:nth-child(1)'), 
            {opacity:0, yPercent:100}, { opacity:1, yPercent:0}, "riverplate") 
        .to($arc_arrows.find('figure:nth-child(1)'), {opacity:0}, "forestplate")
        .fromTo($arc_arrows.find('figure:nth-child(2)'), 
            {opacity:0, yPercent:-100}, { opacity:1, yPercent:0}, "riverplate") 
        .to($arc_arrows.find('figure:nth-child(2)'), {opacity:0}, "forestplate")
        
        .to($arc_svg, {opacity:1}, "forestplate")
        .set($arc_svg.find('path'), {drawSVG:"100% 100%"}, "forestplate")
        .to($arc_svg.find('path'), {drawSVG:"0% 100%", ease: Power3.easeOut}, "forestplate")
        .to($arc_svg, {opacity:0}, "oceanplate")

        .fromTo($arc_arrows.find('figure:nth-child(4)'), 
            {opacity:0, xPercent: 100}, { opacity:1, xPercent:0}, "oceanplate")
        .to($arc_arrows.find('figure:nth-child(4)'), {opacity:0}, "lastplate");
...
// 오션힐즈 무한루핑 슬라이드 모바일 
function oceanhills_slide_mobile(){
...
// .set($arc_arrows.find('div:nth-child(1)'), {transformOrigin: "100% 100%"}, "riverplate")
// .to($arc_arrows.find('div:nth-child(1)'), {opacity:1}, "riverplate")
// .fromTo('.now-di--oceanhills-arc-river-arrows div:nth-child(1) figure',{opacity:0,  y: 137 / 2} , { opacity:1,  y: 0}, "riverplate") 
// .to($arc_arrows.find('div:nth-child(1)'), {opacity:0}, "forestplate")

// .set($arc_arrows.find('div:nth-child(2)'), {transformOrigin: "0% 0%"}, "riverplate")
// .to($arc_arrows.find('div:nth-child(2)'), {opacity:1}, "riverplate")
// .fromTo('.now-di--oceanhills-arc-river-arrows div:nth-child(2) figure', 
//     {opacity:0, y: -(137 / 2)}, { opacity:1, y: 0}, "riverplate") 
// .to($arc_arrows.find('div:nth-child(2)'), {opacity:0}, "forestplate")

// .set($arc_arrows.find('figure:nth-child(3)'), {transformOrigin: "0% 0%"}, "forestplate")
// .fromTo($arc_arrows.find('figure:nth-child(3)'), 
//     {opacity:0, x: -gsap.getProperty('.now-di--oceanhills-arc-river-arrows > figure:nth-child(3)','width') / 2}, { opacity:1, x: 0}, "forestplate") 
// .to($arc_arrows.find('figure:nth-child(3)'), {opacity:0}, "oceanplate")

// .set($arc_arrows.find('figure:nth-child(4)'), {transformOrigin: "100% 100%"}, "oceanplate")
// .fromTo($arc_arrows.find('figure:nth-child(4)'), 
// {opacity:0, x: gsap.getProperty('.now-di--oceanhills-arc-river-arrows > figure:nth-child(4)','width') / 2}, { opacity:1, x: 0}, "oceanplate") 
// .to($arc_arrows.find('figure:nth-child(4)'), {opacity:0}, "lastplate");