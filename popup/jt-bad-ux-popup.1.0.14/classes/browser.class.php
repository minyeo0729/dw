...
class Browser
{
    ...
    const BROWSER_NAVER = 'NAVER';
    const BROWSER_KAKAO = 'KAKAOTALK';
    /**#@-*/
    /**#@+
    ...
    protected function checkBrowsers()
    {
        ...
        return
               ...
               $this->checkBrowserNaver() ||
               $this->checkBrowserKakao() ||
    ...
    protected function checkBrowserNaver()
    {
        return $this->checkSimpleBrowserUA('NAVER', $this->_agent, self::BROWSER_NAVER, true);
    }

    protected function checkBrowserKakao()
    {
        return $this->checkSimpleBrowserUA('KAKAOTALK', $this->_agent, self::BROWSER_KAKAO, true);
    }
    /**
