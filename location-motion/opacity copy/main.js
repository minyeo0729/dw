...
// .to(mouth_close, 0.1, {opacity: 0, ease: Sine.easeIn}, "-=.3") //too obvious
.to(mouth_open, 0.3, {y: -1, opacity: 1, ease: Sine.easeIn}, "-=.5")
.to(mouth_open, 0.1, {y: 4, scaleY: 0, ease: Sine.easeIn})
// .to(mouth_close, 0.1, {opacity: 1, ease: Sine.easeIn})
...
albert.addEventListener('click',(e)=>{
  albert_jump.pause();
})